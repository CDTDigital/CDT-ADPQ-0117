...
public class CustomerOrdersCollectionThymeleafController {
     ...
     */
    @Autowired
    public CustomerOrdersCollectionThymeleafController(CustomerOrderService customerOrderService, MessageSource messageSource) {
    ...
    public static UriComponents listURI() {
        return MvcUriComponentsBuilder.fromMethodCall(MvcUriComponentsBuilder.on(CustomerOrdersCollectionThymeleafController.class).list(null)).build().encode();
    }
    ...
    @ResponseBody
    public ResponseEntity<DatatablesData<CustomerOrder>> datatables(GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
    ...
    @ResponseBody
    public ResponseEntity<Select2Data<CustomerOrder>> select2(GlobalSearch search, Pageable pageable, Locale locale) {
        Page<CustomerOrder> CustomerOrders = customerOrderService.findAll(search, pageable);
