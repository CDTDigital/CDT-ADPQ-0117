...
privileged aspect CategoriesItemThymeleafController_Roo_Thymeleaf {
     ...
     */
    public MessageSource CategoriesItemThymeleafController.messageSource;
     ...
     */
    @Autowired
    public CategoriesItemThymeleafController.new(CategoryService categoryService, MessageSource messageSource) {
     ...
     */
    @ModelAttribute
    public Category CategoriesItemThymeleafController.getCategory(@PathVariable("category") Long id) {
     ...
     */
    public static UriComponents CategoriesItemThymeleafController.showURI(Category category) {
        return MvcUriComponentsBuilder
            .fromMethodCall(
                MvcUriComponentsBuilder.on(CategoriesItemThymeleafController.class).show(category, null))
    ...
    public ModelAndView CategoriesItemThymeleafController.update(@Valid @ModelAttribute Category category, BindingResult result, Model model) {
        if (result.hasErrors()) {
            populateForm(model);
