...
privileged aspect CustomerOrderRepositoryCustom_Roo_Jpa_Repository_Custom {
     ...
     * @return Page
     */
    public abstract Page<CustomerOrder> CustomerOrderRepositoryCustom.findByUserInfo(UserInfo userInfo, GlobalSearch globalSearch, Pageable pageable);
     ...
     * @return Page
     */
    public abstract Page<CustomerOrder> CustomerOrderRepositoryCustom.findByStatus(Status status, GlobalSearch globalSearch, Pageable pageable);
